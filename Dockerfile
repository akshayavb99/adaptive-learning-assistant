...
COPY rag_retriever.py database.py embedding.py openai_rag_client.py usage.py question_bank.py retrieval_evaluation.py generate_gold_truth.py main.py chat.py streamlit_app.py ./
COPY tests ./tests
